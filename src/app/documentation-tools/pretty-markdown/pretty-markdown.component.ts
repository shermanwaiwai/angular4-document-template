import {
  Component, Directive, AfterViewInit, ElementRef, Input, Renderer2, SecurityContext, Type, ComponentFactory,
  ViewContainerRef, ComponentFactoryResolver, Injector, ComponentRef, ViewChild, ChangeDetectorRef,
} from '@angular/core';
